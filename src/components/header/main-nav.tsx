              ...
              return (
                <li key={item} className="flex items-center">
                  <Link
                    ...
                    className={cn(
                      "group flex h-12 items-center justify-center px-4 font-['Raleway'] text-xs sm:text-sm tracking-[0.2em] transition-all hover:bg-gray-50",
                  ...
                  {index < navItems.length - 1 && <div className="h-12 w-px self-center bg-gray-100" />}
                </li>
              )
            })}
          </ul>

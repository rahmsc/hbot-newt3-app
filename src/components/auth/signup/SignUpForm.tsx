      ...
      <div className="flex-grow overflow-y-auto px-4 py-8 sm:px-6 lg:px-8">
        <Card className="relative mx-auto max-w-md rounded-lg border bg-white/95 shadow-md">
          <CardHeader className="space-y-2">
            ...
            <CardDescription className="px-4 text-center text-sm text-gray-600">
              Join to get access to Hyperbaric HQ. Search for and save your
              favourite content. Connect with others. Work with experts. Get
              exclusive deals.
            </CardDescription>
          </CardHeader>

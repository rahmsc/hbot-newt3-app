    ...
    <section className="w-full bg-[#FAF7F4]">
      <div className="container mx-auto px-4 pt-24">
        <div className="mx-auto max-w-4xl space-y-12 text-center">
          <h2 className="font-['Raleway'] text-4xl font-medium tracking-[0.3em] text-gray-900 sm:text-5xl">
            GET STARTED WITH HBOT
          </h2>
          <div className="space-y-6">
            <p className="text-2xl font-light text-gray-600 sm:text-3xl">
            ...
            <p className="text-lg italic text-gray-600 sm:text-xl">
          ...
          <div className="flex justify-center">
            <a
              href="tel:1234567890"
              className="group inline-flex items-center gap-3 rounded-full bg-gray-900 px-8 py-4 text-base font-medium text-white transition-colors hover:bg-gray-800"
            >

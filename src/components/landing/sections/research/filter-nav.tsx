...
export function FilterNav({
  ...
  const selectedCategoryConditions = React.useMemo(() => {
    return selectedCategory
      ? categories.find((category) => category.id === selectedCategory)?.conditions ?? []
      : [];
            ...
            <div className="flex items-center space-x-3">
              {categories.map((category) => (
                <button
                  ...
                  className={`group flex items-center gap-1.5 whitespace-nowrap rounded-full border px-6 py-1.5 text-sm font-medium transition-all hover:bg-gray-100 ${
            ...
            <div className="flex items-center space-x-3">
              ...
              {selectedCategoryConditions.map((condition) => (
                <button
                  ...
                  className={`flex items-center whitespace-nowrap rounded-full border px-6 py-1 text-sm font-medium transition-all hover:bg-gray-100 ${

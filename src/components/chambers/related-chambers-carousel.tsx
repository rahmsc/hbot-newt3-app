...
export function RelatedChambersCarousel({ chambers, imageUrl }: RelatedChambersCarouselProps) {
      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex">
          {chambers.map((chamber) => (
            ...
            >
              <Link href={`/chambers/${chamber.name?.toLowerCase().replace(/\s+/g, '-')}`} className="block transition-all hover:-translate-y-1">
                <div className="overflow-hidden rounded-2xl bg-white shadow hover:shadow-lg">
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="mt-1 text-lg font-bold tracking-wide">{chamber.name}</h3>
